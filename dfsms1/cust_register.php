...
if(isset($_POST['register'])) {
    ...
    if ($password != $password) {
        ...
        $check_query = "SELECT * FROM tblcust WHERE username='$username' OR email='$emailid'";
        ...
        $insert_query = "INSERT INTO tblcust (custname, username, email, mobilenumber, password) VALUES ('$custname','$username', '$emailid','$mobilenumber', '$password')";
    ...
    <div class="container">
        ...
        <form action="cust_register.php" method="post">
           <div class="form-group">
            ...
            <p>Already have an account? <a href="login_cust.php">Login here</a></p>
        </form>
    </div>
